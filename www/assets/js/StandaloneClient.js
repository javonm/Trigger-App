...
function StandaloneClient(root) {
	...
	//TODO: '<td><div class=button id=otaButton></div></td>' +
	...
	var infoPageButtons = '<span id="infoPageButtons" class="hiddenSpan"><button id="factoryResetButton" class="button">Factory Reset</button></span>';
	
	//var settingsbutton = '<img id="settingsButton" class="button toggleButton">';
	
	this.appMenu.content.innerHTML = devicePageButtons + projectPageButtons + debugPageButtons + infoPageButtons;
	...
	this.appMenu.content.infoPageButtons = document.getElementById('infoPageButtons');
	this.appMenu.content.factoryResetButton = document.getElementById('factoryResetButton');
	...
	//TODO: this.appBar.content.otaButton = document.getElementById('otaButton');
}
...
StandaloneClient.prototype.clearMenuClass = function() {
	...
	//TODO: this.appBar.content.otaButton.className = "";
};
...
StandaloneClient.prototype.showDebugLog = function() {
	...
	this.appMenu.content.infoPageButtons.style.display = "none";
